# Limite de suite : ce qu'il faut savoir faire
...
- Pour $u_{n+1} = f(u_n)$ : [le théorème du point fixe](../../Continuite/Continuite_base/01_cont_fct.md#th_pt_fixe) dans une version simplifiée : on admet que $\ell$ vérifie $f(\ell) = \ell$
- Pour $u_{n+1} = f(u_n)$ : à la place du point fixe, l'utilisation de la continuité de $f$
